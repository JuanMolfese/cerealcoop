                ...
                <div className="-mx-4 flex flex-wrap">
                  <div className="w-full px-4 md:w-1/2">
                    <div className="mb-8  hover:text-green dark:hover:text-green">
                      <Link href="https://maps.app.goo.gl/VBvaxE1udhaViQyF6" target="_blank" className="flex align-middle">
                    ...
                    <div className="mb-8 hover:text-green dark:hover:text-green">
                      <Link href="tel:+542983574647" target="_blank" className="flex align-middle">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6 mr-2">
                  ...
                  <div className="w-full px-4 md:w-1/2">
                    <div className="mb-8 hover:text-green dark:hover:text-green">
                      <Link href="mailto:info@cerealcoop.com.ar" target="_blank" className="flex align-middle">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6 mr-2">
                          <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 0 1-2.25 2.25h-15a2.25 2.25 0 0 1-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25m19.5 0v.243a2.25 2.25 0 0 1-1.07 1.916l-7.5 4.615a2.25 2.25 0 0 1-2.36 0L3.32 8.91a2.25 2.25 0 0 1-1.07-1.916V6.75" />
                      </svg>
                        info@cerealcoop.com.ar
                      </Link>
                    </div>
                    <div className="mb-8 hover:text-green dark:hover:text-green">
                      <Link href="//api.whatsapp.com/send?phone=542983574647" target="_blank" className="flex align-middle">
                        <svg
                  ...
                  <div className="w-full px-4 md:w-1/2">
                    ...
                    <div className="mb-8 hover:text-green dark:hover:text-green">
                      <Link href="mailto:jtorres@cerealcoop.com.ar" target="_blank" className="flex align-middle">                      
                      <svg className="w-[24px] h-[24px] text-gray-800 dark:text-white mr-2" aria-hidden="true"                           
                          xmlns="http://www.w3.org/2000/svg" 
                          width="24" height="24"
