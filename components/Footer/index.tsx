      ...
      >
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 lg:max-w-[200px] max-w-[200px] lg:mb-16">
                ...
                {/* <div className="flex items-center">
                  <a
                    href="https://www.facebook.com/cerealcoop"
                  ...
                  <a
                    href="https://www.instagram.com/cerealcoop/"
                    aria-label="social-link"
            ...
            <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
              <div className="mb-12 lg:mb-16">
                ...
                <ul>
                  ...
                  <li>
                    <div className="dark:text-body-color-dark mb-4 text-base text-body-color duration-300 hover:text-green dark:hover:text-green">
                      <Link href="https://www.linkedin.com/company/cooperativa-de-trabajo-cerealcoop-ltda/" target="_blank" className="flex align-middle">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="h-5 w-5"
                        fill="currentColor"
        ...
        <div className="absolute right-0 top-14 z-[-1]">
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <circle opacity="0.3" cx="49.5" cy="49.5" r="49.5" fill="#c6da52" />
            <mask
              id="mask0_94:899"
          ...
          >
            ...
            <defs>
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="#c6da52" stopOpacity="0.62" />
                <stop offset="1" stopColor="#c6da52" stopOpacity="0" />
              </linearGradient>
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="#c6da52" stopOpacity="0" />
                <stop offset="1" stopColor="#c6da52" stopOpacity="0.51" />
              </linearGradient>
              <linearGradient
